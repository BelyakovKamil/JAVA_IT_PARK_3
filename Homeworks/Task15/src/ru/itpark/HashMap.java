...
public class HashMap<K, V> {
    ...
    public void iteratorOfBuckets() {
        for (int i = 0; i < buckets.length; i++) {
            BucketsIterator iterator = new BucketsIterator(i);
    ...
    private class BucketsIterator<K> implements Iterator<K> {

        private Node currentNode;

        BucketsIterator(int index) {
